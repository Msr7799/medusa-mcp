...
function assertAllowedAdminPath(path: string) {
...
async function planOrExecute(
  plan: WritePlan,
  opts: { dry_run?: boolean; requireConfirm?: boolean } = {}
) {
...
export const tools = {
  ...
  admin_get_collection: {
    ...
    handler: async (input: any) => {
      const data = await medusaRequest(
        "GET",
        `/admin/product-collections/${encodeURIComponent(input.id)}`
      );
      return toolText(data);
    },
  },
  ...
  admin_create_product: {
    description:
      "Create a product (/admin/products). Returns dry-run plan + confirm token by default; call admin_confirm to execute.",
    schema: {
  ...
  admin_update_product: {
    description:
      "Update a product (/admin/products/:id). Returns dry-run plan + confirm token by default; call admin_confirm to execute.",
    schema: {
      id: z.string().min(1),
  ...
  admin_delete_product: {
    description:
      "Delete a product (/admin/products/:id). Returns dry-run plan + confirm token by default; call admin_confirm to execute.",
    schema: {
      id: z.string().min(1),
      dry_run: z.boolean().optional(),
    },
  ...
  admin_create_collection: {
    description:
      "Create a product collection (/admin/product-collections). Returns dry-run plan + confirm token by default; call admin_confirm to execute.",
    schema: {
  ...
  admin_update_collection: {
    description:
      "Update a product collection (/admin/product-collections/:id). Returns dry-run plan + confirm token by default; call admin_confirm to execute.",
    schema: {
      id: z.string().min(1),
      patch: z.record(z.any()).describe("Fields to update"),
      dry_run: z.boolean().optional(),
  ...
  admin_delete_collection: {
    description:
      "Delete a product collection (/admin/product-collections/:id). Returns dry-run plan + confirm token by default; call admin_confirm to execute.",
    schema: {
      id: z.string().min(1),
      dry_run: z.boolean().optional(),
    },
  ...
  admin_create_category: {
    description:
      "Create a product category (/admin/product-categories). Returns dry-run plan + confirm token by default; call admin_confirm to execute.",
    schema: {
  ...
  admin_update_category: {
    description:
      "Update a product category (/admin/product-categories/:id). Returns dry-run plan + confirm token by default; call admin_confirm to execute.",
    schema: {
      id: z.string().min(1),
      patch: z.record(z.any()).describe("Fields to update"),
      dry_run: z.boolean().optional(),
  ...
  admin_delete_category: {
    description:
      "Delete a product category (/admin/product-categories/:id). Returns dry-run plan + confirm token by default; call admin_confirm to execute.",
    schema: {
      id: z.string().min(1),
      dry_run: z.boolean().optional(),
    },
  ...
  admin_request: {
    description:
      "Generic Admin API request with optional confirm for writes. Allowed paths: /admin and /auth only.",
    schema: {
    ...
    handler: async (input: any) => {
      const method = input.method as "GET" | "POST" | "PUT" | "DELETE";
  ...
  ui_navigate: {
    ...
    handler: async (input: any) =>
      toolText({ ok: true, action: "NAVIGATE", path: input.path }),
  },
  ...
  ui_toast: {
    ...
    handler: async (input: any) =>
      toolText({ ok: true, action: "TOAST", kind: input.kind, message: input.message }),
  },
  ...
  ui_prefill_form: {
    ...
    handler: async (input: any) =>
      toolText({ ok: true, action: "PREFILL_FORM", form: input.form, values: input.values }),
  },
} as const;
